...
<section class="message-wrap">
  <div class="container-fluid">
              ...
              <div  class="col-xs-6 col-md-4"><a id="mybtn" href="nosvehicule.php" class="btn btn-lg btn-primary pull-right">Contactez &amp; Reserver</a> </div>
          </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 margin-bottom-none">
                            ...
                            <p class="margin-bottom-none"><strong style="color:#fd0f19"></strong>Pour vos locations de voiture Marrakech, Smart locationf
                              vous proposons plusieurs produits et services adaptés à vos besoins. </p>
